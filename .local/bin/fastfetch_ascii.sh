...
#ASCII_FILE="/home/ln607/.config/fastfetch/ascii/waifu.txt"
#ASCII_FILE="/home/ln607/.config/fastfetch/ascii/nier.txt"
...
padding_top=$(((ascii_height) % 10))

#echo $padding_top
# Ensure non-negative padding
# padding_left=$((padding_left < 0 ? 0 : padding_left))
padding_top=$((ascii_height > 20 ? 0 : padding_top))
...
if [ -n "$ASCII_FILE" ]; then
  fastfetch --file "$ASCII_FILE" --logo-padding-left 5 --logo-padding-top "$padding_top" --logo-height "$padding_top"
