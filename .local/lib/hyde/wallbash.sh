...
# Ensure just the file name (no path) is used
imgFileName="$(basename "$wallbashImg")"

wallbashRaw="${wallbashDir}/${imgFileName}.mpc"
wallbashOut="${wallbashDir}/${imgFileName}.dcol"
wallbashCache="${wallbashDir}/${imgFileName}.cache"
